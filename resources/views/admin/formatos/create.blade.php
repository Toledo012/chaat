...
@section('styles')
    <style>
        ...
        .card-format-r { border-bottom: 5px solid #6f42c1 !important; }
        .card-format-r .icon-box { background-color: #f3e8ff; color: #6f42c1; }
...
@section('content')
    <div class="container-fluid px-4 py-3">
        ...
        <div class="row g-4 justify-content-center">
            ...
            {{-- FORMATO RECEPCIÓN --}}
            <div class="col-md-6 col-xl-3">
                <a href="{{ route('admin.formatos.r') }}" class="card h-100 shadow-sm selector-card card-format-r">
                    <div class="card-body p-4 text-center">
                        <div class="icon-box shadow-sm">
                            <i class="fas fa-box-open fa-2x"></i>
                        </div>
                        <h4 class="format-title">Formato Recepción</h4>
                        <p class="format-desc">Registro de Artículos, Equipos y Materiales Recibidos</p>
                        <div class="btn-select mt-3">
                            <span class="badge rounded-pill px-3 py-2" style="background-color:#6f42c1;">Seleccionar <i class="fas fa-chevron-right ms-1"></i></span>
                        </div>
                    </div>
                </a>
            </div>
